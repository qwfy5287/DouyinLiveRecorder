...
// // https://www.bohaishibei.com/post/89646/
...
//     // let url = "https://www.bohaishibei.com/post/89646/";
//     // let file_path = "89646.html";
//     // let url = "https://www.douyin.com/user/MS4wLjABAAAAMxYi9PvREOLNQ5naiFnKk_NzYpoLRp_3c5iWhZuCoJAYr0md9ScXIvpB93Pz_BSD";
//     let url = "https://www.bing.com";
//     let file_path = "aaa.html";
...
// use std::fs::File;
// use std::io::Write;
// use reqwest::header::{HeaderMap, HeaderValue, USER_AGENT, ACCEPT, ACCEPT_LANGUAGE, CACHE_CONTROL, PRAGMA, UPGRADE_INSECURE_REQUESTS};
// use tokio;
...
// async fn save_to_file(content: &str, file_path: &str) -> Result<(), Box<dyn std::error::Error>> {
//     let mut file = File::create(file_path)?;
//     file.write_all(content.as_bytes())?;
//     Ok(())
// }
...
//     save_to_file(&content, file_path).await?;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let content = common::douyin::fetch_url(url).await?;
    save_to_file(&content, file_path).await?;
